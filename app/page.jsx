...
export default function Home() {
  return (
    <div style={{ minHeight: '100vh', backgroundColor: '#05070b', color: '#f3f4f6', fontFamily: 'sans-serif' }}>
      
      {/* Navigation Header (Strategic Balance: Black base, Blue accents, Red highlight line) */}
      <nav style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '1.25rem 2rem', backgroundColor: '#0b0f19', borderBottom: '2px solid #dc2626' }}>
        ...
        <div style={{ display: 'flex', gap: '2rem', alignItems: 'center' }}>
          ...
          <Link href="/packages" style={{ color: '#d1d5db', textDecoration: 'none', fontWeight: '500' }}>Solar Packages</Link>
          <Link href="/services" style={{ color: '#d1d5db', textDecoration: 'none', fontWeight: '500' }}>Services</Link>
      ...
      <section style={{ maxWidth: '1200px', margin: '0 auto', padding: '5rem 2rem', textAlign: 'center' }}>
        <div style={{ display: 'inline-block', backgroundColor: 'rgba(220, 38, 38, 0.12)', color: '#ef4444', padding: '0.5rem 1.25rem', borderRadius: '9999px', fontSize: '0.875rem', fontWeight: '700', marginBottom: '1.5rem', border: '1px solid rgba(220, 38, 38, 0.3)' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'center', gap: '1rem' }}>
          <Link href="/quote" style={{ backgroundColor: '#2563eb', color: '#ffffff', padding: '1rem 2.5rem', borderRadius: '0.75rem', fontWeight: 'bold', textDecoration: 'none', boxShadow: '0 4px 14px rgba(37, 99, 235,-0.4)' }}>
            Request a Free Quote
          </Link>
          <Link href="/packages" style={{ backgroundColor: '#0b0f19', color: '#ffffff', padding: '1rem 2.5rem', borderRadius: '0.75rem', fontWeight: 'bold', textDecoration: 'none', border: '1px solid #dc2626' }}>
            View Solar Packages
          </Link>
        </div>
      </section>
      ...
      <section style={{ maxWidth: '1200px', margin: '0 auto', padding: '2rem 2rem 5rem 2rem', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '2rem' }}>
        <div style={{ backgroundColor: '#0b0f19', padding: '2rem', borderRadius: '1rem', borderTop: '4px solid #2563eb', borderLeft: '1px solid #1f2937', borderRight: '1px solid #1f2937', borderBottom: '1px solid #1f2937' }}>
        ...
        <div style={{ backgroundColor: '#0b0f19', padding: '2rem', borderRadius: '1rem', borderTop: '4px solid #dc2626', borderLeft: '1px solid #1f2937', borderRight: '1px solid #1f2937', borderBottom: '1px solid #1f2937' }}>
